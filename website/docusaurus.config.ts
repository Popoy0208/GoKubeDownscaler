    ...
    [
      "classic",
      {
        ...
        docs: {
          ...
          editUrl:
            "https://github.com/sparklingca/GoKubeDownscaler/edit/main/website",
        },
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: "https://github.com/sparklingca/GoKubeDownscaler",
          "aria-label": "GitHub",
          position: "right",
    ...
    announcementBar: {
      id: "star_downscaler",
      content:
        '⭐️ If you like GoKubeDownscaler, give it a star on <a target="_blank" rel="noopener noreferrer" href="https://github.com/sparklingca/GoKubeDownscaler">GitHub</a>! ⭐️',
    },
    footer: {
      style: "dark",
