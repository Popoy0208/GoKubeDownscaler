...
-> `https://github.com/sparklingca/GoKubeDownscaler/tree/main/path/to/file`
...
They can be any of [the GoKubeDownscalers Labels](https://github.com/sparklingca/GoKubeDownscaler/labels)
